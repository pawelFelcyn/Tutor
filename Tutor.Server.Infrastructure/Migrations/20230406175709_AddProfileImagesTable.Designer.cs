...
namespace Tutor.Server.Infrastructure.Migrations
{
    ...
    [Migration("20230406175709_AddProfileImagesTable")]
    partial class AddProfileImagesTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Tutor.Server.Domain.Entities.ProfileImage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Tutor.Server.Domain.Entities.TutorEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Tutor.Server.Domain.Entities.ProfileImage", b =>
                {
                    b.HasOne("Tutor.Server.Domain.Entities.User", "User")
                        .WithOne("PofileImage")
                        .HasForeignKey("Tutor.Server.Domain.Entities.ProfileImage", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Tutor.Server.Domain.Entities.TutorEntity", b =>
                {
                    b.HasOne("Tutor.Server.Domain.Entities.User", "User")
                        .WithOne("Tutor")
                        .HasForeignKey("Tutor.Server.Domain.Entities.TutorEntity", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
